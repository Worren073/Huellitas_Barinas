          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-stack-md">
              <h1 className="font-montserrat text-headline-xl md:text-[56px] md:leading-[64px] font-bold text-on-surface">
                Encuentra a tu proximo
                <span className="text-primary"> companero</span> de vida
              </h1>
              <p className="font-body-lg text-on-surface-variant max-w-lg">
                Miles de mascotas en Barinas esperan un hogar. Explora nuestros centros de adopcion y dales el amor que merecen.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl shadow-card w-full h-[400px] bg-surface-container-high flex items-center justify-center">
                <Icon name="pets" className="w-24 h-24 text-outline" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="sobre-nosotros" className="bg-surface-gray py-stack-lg">
          <div className="max-w-container-max mx-auto px-4 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { step: '1', title: 'Explora', icon: 'search', desc: 'Busca entre cientos de mascotas disponibles en centros de adopcion de Barinas.' },
                { step: '2', title: 'Conecta', icon: 'favorite', desc: 'Elige a tu favorita y contacta directamente con el centro de adopcion.' },
                { step: '3', title: 'Adelante', icon: 'celebration', desc: 'Completa el proceso de adopcion y dale un hogar a quien mas lo necesita.' },
              ].map((item) => (
                <div key={item.step} className="bg-surface p-8 rounded-2xl shadow-sm border border-surface-container-high hover:shadow-md relative overflow-hidden group">
        ...
        <section className="py-stack-lg">
          <div className="max-w-container-max mx-auto px-4 md:px-8">
            <div className="flex justify-between items-center mb-stack-md">
              <h2 className="font-montserrat text-headline-lg text-on-surface">Ultimos Rescatados</h2>
          ...
          <div className="max-w-container-max mx-auto px-4 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {centers.map((center) => (
                <div
                  key={center.id}
                  className="bg-surface rounded-2xl p-6 flex items-center gap-6 shadow-sm border border-surface-container-high hover:border-primary-container transition-colors cursor-pointer"
                >
