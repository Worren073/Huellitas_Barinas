...
class TestUserModel:
    ...
    def test_email_unique(self, db):
        User.objects.create_user(username="user1", email="same@test.com", password="pass1234")
        with pytest.raises(IntegrityError):
            User.objects.create_user(username="user2", email="same@test.com", password="pass1234")
    ...
    def test_role_properties(self, db):
        user = User.objects.create_user(
            username="admin", email="a@test.com", password="pass1234", role="center_admin"
        )
