...
class Pet(models.Model):
    ...
    species = models.CharField(max_length=20, choices=Species.choices, verbose_name="especie")
    ...
    size = models.CharField(max_length=20, choices=Size.choices, verbose_name="tamaño")
    gender = models.CharField(
        max_length=10, choices=[("M", "Macho"), ("F", "Hembra")], verbose_name="género"
    )
    ...
    center = models.ForeignKey(
        "centers.Center", on_delete=models.CASCADE, related_name="pets", verbose_name="centro"
    )
...
class PetImage(models.Model):
    ...
    pet = models.ForeignKey(
        Pet, on_delete=models.CASCADE, related_name="images", verbose_name="mascota"
    )
